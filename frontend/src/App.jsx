...
import "./styles.css";
import { apiGet, apiPost, authTokenStorageKey } from "./api";
...
export default function App() {
  ...
  async function doLogin(e) {
    ...
    try {
      ...
      localStorage.setItem(authTokenStorageKey, t);
      setToken(t);
    } catch (err) {
        ...
        <div className="card" style={{ maxWidth: 520, margin: "40px auto" }}>
          <div className="header">
            <div>
              ...
              <div className="muted">Đăng nhập để truy cập dashboard</div>
            </div>
          </div>
          ...
          <>
            <div className="header" style={{ borderBottom: "none" }}>
              ...
              <form className="row" onSubmit={submitAction}>
                <input placeholder="src_ip" value={ip} onChange={(e) => setIp(e.target.value)} required />
